<?php
    ...
    function sendMail($email,$v_code){
        ...
        try {
            ...
            <a href='https://harshramwani.com/hackathon/hackathon_wizards_synopsis-main/src/verify/verify_club.php?email=$email&v_code=$v_code'>Verify</a>";
    ...
    $last_id = 0;
    $query_leader_id = "SELECT MAX(leader_id) as last_id FROM club_registration";
