<?php
    ...
    $insert_query_institute_registration = "insert into institute_registration(i_name, i_code, i_state, i_city, i_pass, admin_name, admin_mobile, admin_email, admin_user, admin_pass, verification_code, is_verified) VALUES ('". $registration_data['i_name'] ."','". $registration_data['i_code'] ."','". $registration_data['i_state'] ."','". $registration_data['i_city'] ."','". $registration_data['i_pass'] ."','". $registration_data['admin_name'] ."','". $registration_data['admin_mobile'] ."','". $registration_data['admin_email'] ."','". $registration_data['admin_user'] ."','". $registration_data['admin_pass']."','$v_code','0')";
